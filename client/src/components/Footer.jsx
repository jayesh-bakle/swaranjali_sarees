...
export default function Footer() {
  return (
    <footer className="bg-primary-900 text-slate-300 mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-slate-400 max-w-md">
              Handpicked, handwoven Paithani silk sarees from the master weavers of Yeola, Maharashtra —
              crafted with pure silk and genuine gold zari, just as it has been for over 2000 years.
            </p>
            <div className="flex gap-4 mt-4">
              <a href="#" className="text-slate-400 hover:text-gold-400 transition-colors" aria-label="Instagram">
              ...
              <a href="#" className="text-slate-400 hover:text-gold-400 transition-colors" aria-label="Facebook">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-display text-lg text-white mb-4 tracking-wide">Quick Links</h3>
            <ul className="space-y-2 text-sm">
              <li><Link to="/" className="hover:text-gold-400 transition-colors">Home</Link></li>
              <li><Link to="/shop" className="hover:text-gold-400 transition-colors">Shop Paithani</Link></li>
